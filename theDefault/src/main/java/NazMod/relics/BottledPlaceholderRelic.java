...
import NazMod.patches.relics.BottledPlaceholderField;
import NazMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static NazMod.DefaultMod.makeRelicOutlinePath;
import static NazMod.DefaultMod.makeRelicPath;
